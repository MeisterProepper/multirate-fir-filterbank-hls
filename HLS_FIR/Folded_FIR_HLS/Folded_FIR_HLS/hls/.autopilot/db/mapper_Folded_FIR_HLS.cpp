...
using hls::sim::Byte;
extern "C" void Folded_FIR_HLS(short*, short*);
extern "C" void apatb_Folded_FIR_HLS_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
auto* soutput_r = createStream((hls::stream<short>*)__xlx_apatb_param_output_r);
  // DUT call
  Folded_FIR_HLS(sinput_r->data<short>(), soutput_r->data<short>());
