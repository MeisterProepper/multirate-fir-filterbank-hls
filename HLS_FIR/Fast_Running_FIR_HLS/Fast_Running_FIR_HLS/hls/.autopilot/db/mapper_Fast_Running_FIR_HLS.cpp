...
using hls::sim::Byte;
extern "C" void Fast_Running_FIR_HLS(short*, short*);
extern "C" void apatb_Fast_Running_FIR_HLS_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
auto* soutput_r = createStream((hls::stream<short>*)__xlx_apatb_param_output_r);
  // DUT call
  Fast_Running_FIR_HLS(sinput_r->data<short>(), soutput_r->data<short>());
