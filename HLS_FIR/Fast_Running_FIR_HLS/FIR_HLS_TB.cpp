...
// File names
const char INPUT_FILENAME[]     = "../../../../../../Matlab/TS_HLS_fastrunning.dat";
const char REFERENCE_FILENAME[] = "../../../../../../Matlab/TS_HLS_fastrunning.res";
...
int main() {
    ...
    for (int i = 0; i < num_input_samples; i++) {
        Fast_Running_FIR_HLS(input_stream, output_stream);
    }
