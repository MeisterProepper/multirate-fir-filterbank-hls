...
using hls::sim::Byte;
extern "C" void Direct_FIR_DSP_HLS(short*, short*);
extern "C" void apatb_Direct_FIR_DSP_HLS_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
auto* soutput_r = createStream((hls::stream<short>*)__xlx_apatb_param_output_r);
  // DUT call
  Direct_FIR_DSP_HLS(sinput_r->data<short>(), soutput_r->data<short>());
