...
AUTOPILOT_ROOT := C:/AMD/Vitis/2024.2
...
ifndef AP_GCC_PATH
  AP_GCC_PATH := C:/AMD/Vitis/2024.2/tps/win64/msys64/mingw64/bin
endif
AUTOPILOT_TOOL = ${AUTOPILOT_ROOT}/${AUTOPILOT_MACH}/tools
AUTOPILOT_TECH = ${AUTOPILOT_ROOT}/common/technology
  AP_CLANG_PATH := C:/AMD/Vitis/2024.2/vcxx/libexec/
TOOLCHAIN += --sysroot=C:/AMD/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
LFLAG += --sysroot=C:/AMD/Vitis/2024.2/tps/mingw/10.0.0/win64.o/nt
...
LFLAG += -lpthread
LFLAG += -L C:/AMD/Vitis/2024.2/vcxx/lib/clang/14.0.6/lib/windows -lclang_rt.builtins-x86_64
...
$(ObjDir)/FIR_HLS_TB.cpp_pre.cpp.tb.o : FIR_HLS_TB.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling FIR_HLS_TB.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
...
$(ObjDir)/FIR_HLS.cpp_pre.cpp.tb.o : FIR_HLS.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling FIR_HLS.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
