...
// tvout file define:
#define AUTOTB_TVOUT_PC_output_r "../tv/rtldatafile/rtl.Direct_FIR_DSP.autotvout_output_r.dat"
...
extern "C"
void Direct_FIR_DSP_hw_stub_wrapper(void*, void*);

extern "C"
void apatb_Direct_FIR_DSP_hw(void* __xlx_apatb_param_input_r, void* __xlx_apatb_param_output_r)
{
  ...
  try {
    ...
    Direct_FIR_DSP_hw_stub_wrapper(__xlx_apatb_param_input_r, __xlx_apatb_param_output_r);
    port1.buffer();
