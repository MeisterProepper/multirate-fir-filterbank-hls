...
if {[file isfile Direct_FIR_DSP.autotvin.dat]} {
	file delete -force Direct_FIR_DSP.autotvin.dat
}

if {[file isfile Direct_FIR_DSP.autotvout.dat]} {
	file delete -force Direct_FIR_DSP.autotvout.dat
}
