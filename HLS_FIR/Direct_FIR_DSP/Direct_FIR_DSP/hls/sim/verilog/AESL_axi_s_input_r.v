...
`define TV_IN_input_r_TDATA "../tv/cdatafile/c.Direct_FIR_DSP.autotvin_input_r.dat"
...
module AESL_axi_s_input_r (
    input clk,
    input reset,
    output [16 - 1:0] TRAN_input_r_TDATA,
    ...
    reg [16 - 1:0] input_r_TDATA_write_data;
    reg input_r_TDATA_read_en;
    wire [16 - 1:0] input_r_TDATA_read_data;
    
    fifo #(2, 16) fifo_input_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
