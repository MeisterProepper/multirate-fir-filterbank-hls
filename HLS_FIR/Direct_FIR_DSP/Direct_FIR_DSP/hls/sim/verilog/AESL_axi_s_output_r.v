...
`define TV_OUT_output_r_TDATA "../tv/rtldatafile/rtl.Direct_FIR_DSP.autotvout_output_r.dat"

`define AUTOTB_TRANSACTION_NUM 460

module AESL_axi_s_output_r (
    input clk,
    input reset,
    input [16 - 1:0] TRAN_output_r_TDATA,
    ...
    reg [16 - 1:0] output_r_TDATA_write_data;
    reg output_r_TDATA_read_en;
    wire [16 - 1:0] output_r_TDATA_read_data;
    
    fifo #(2, 16) fifo_output_r_TDATA (
        .reset(1'b0),
        .write_clock(clk),
