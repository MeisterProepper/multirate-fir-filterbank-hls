...
using hls::sim::Byte;
extern "C" void Direct_FIR_DSP(short*, short*);
extern "C" void apatb_Direct_FIR_DSP_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
auto* soutput_r = createStream((hls::stream<short>*)__xlx_apatb_param_output_r);
  // DUT call
  Direct_FIR_DSP(sinput_r->data<short>(), soutput_r->data<short>());
