; ModuleID = 'C:/HLS-multirate-DSP/HLS_FIR/Direct_FIR_HLS/Direct_FIR_HLS/hls/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_Direct_FIR_HLS_ir(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture nonnull dereferenceable(2) %input, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture nonnull dereferenceable(2) %output) local_unnamed_addr #1 {
entry:
  ...
  call void @apatb_Direct_FIR_HLS_hw(i16* %input_copy, i16* %output_copy)
...
declare void @apatb_Direct_FIR_HLS_hw(i16*, i16*)
...
declare void @Direct_FIR_HLS_hw_stub(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture nonnull, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* noalias nocapture nonnull)

define void @Direct_FIR_HLS_hw_stub_wrapper(i16*, i16*) #6 {
entry:
  ...
  call void @Direct_FIR_HLS_hw_stub(%"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %3, %"class.hls::stream<ap_fixed<16, 1, AP_TRN, AP_WRAP, 0>, 0>"* %5)
