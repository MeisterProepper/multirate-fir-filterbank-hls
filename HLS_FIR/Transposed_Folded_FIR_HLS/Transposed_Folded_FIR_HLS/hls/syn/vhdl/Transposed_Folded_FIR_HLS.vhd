...
entity Transposed_Folded_FIR_HLS is
port (
    ap_clk : IN STD_LOGIC;
...
architecture behav of Transposed_Folded_FIR_HLS is 
    ...
    signal p_0_FIR_filter_fu_827_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal p_0_FIR_filter_fu_827_ap_start : STD_LOGIC;
    signal p_0_FIR_filter_fu_827_ap_done : STD_LOGIC;
    signal p_0_FIR_filter_fu_827_ap_idle : STD_LOGIC;
    signal p_0_FIR_filter_fu_827_ap_ready : STD_LOGIC;
    ...
    component Transposed_Folded_FIR_HLS_FIR_filter IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component Transposed_Folded_FIR_HLS_regslice_both IS
    generic (
        DataWidth : INTEGER );
    port (
        ap_clk : IN STD_LOGIC;
...
begin
    p_0_FIR_filter_fu_827 : component Transposed_Folded_FIR_HLS_FIR_filter
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
    ...
    regslice_both_input_r_U : component Transposed_Folded_FIR_HLS_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
    ...
    regslice_both_output_r_U : component Transposed_Folded_FIR_HLS_regslice_both
    generic map (
        DataWidth => 16)
    port map (
        ap_clk => ap_clk,
    ...
    p_0_FIR_filter_fu_827_ap_start_assign_proc : process(ap_CS_fsm_state1, ap_block_state1_ignore_call7)
    begin
        if (((ap_const_boolean_0 = ap_block_state1_ignore_call7) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            p_0_FIR_filter_fu_827_ap_start <= ap_const_logic_1;
        else 
            p_0_FIR_filter_fu_827_ap_start <= ap_const_logic_0;
        end if; 
    end process;
