set moduleName FIR_HLS_Pipeline_VITIS_LOOP_28_2
set isTopModule 0
...
set cdfgNum 4
set C_modelName {FIR_HLS_Pipeline_VITIS_LOOP_28_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ sext_ln28 int 16 regular  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln28", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ sext_ln28 sc_in sc_lv 16 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln28", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "sext_ln28", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.H_accu_FIR1_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_16s_14s_30_1_1_U1", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	sext_ln28 { ap_none {  { sext_ln28 in_data 0 16 } } }
}
