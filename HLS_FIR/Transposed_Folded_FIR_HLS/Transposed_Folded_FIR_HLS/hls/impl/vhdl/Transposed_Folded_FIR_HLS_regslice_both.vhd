...
entity Transposed_Folded_FIR_HLS_regslice_both is
    generic (
        DataWidth   : INTEGER := 8);
    port (
        -- system signals
...
end entity Transposed_Folded_FIR_HLS_regslice_both;

architecture behave of Transposed_Folded_FIR_HLS_regslice_both is
