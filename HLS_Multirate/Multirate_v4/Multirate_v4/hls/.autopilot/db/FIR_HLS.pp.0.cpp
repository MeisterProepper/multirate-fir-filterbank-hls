...
static delay_data_t H_filter_FIR_kernel[117];
static delay_data_t H_filter_FIR_dec_40[6];
static delay_data_t H_filter_FIR_dec_41[5];
static delay_data_t H_filter_FIR_dec_42[5];
static delay_data_t H_filter_FIR_dec_43[5];
static delay_data_t H_filter_FIR_int_40[6];
static delay_data_t H_filter_FIR_int_41[5];
static delay_data_t H_filter_FIR_int_42[5];
static delay_data_t H_filter_FIR_int_43[5];
...
static accu_data_t H_accu_FIR_dec_40[6];
static accu_data_t H_accu_FIR_dec_41[5];
static accu_data_t H_accu_FIR_dec_42[5];
static accu_data_t H_accu_FIR_dec_43[5];
static accu_data_t H_accu_FIR_int_40[6];
static accu_data_t H_accu_FIR_int_41[5];
static accu_data_t H_accu_FIR_int_42[5];
static accu_data_t H_accu_FIR_int_43[5];




__attribute__((sdx_kernel("Multirate_v4", 0))) void Multirate_v4(hls::stream<fir_data_t> &input, hls::stream<fir_data_t> &output);
...
__attribute__((sdx_kernel("Multirate_v4", 0))) void Multirate_v4(hls::stream<fir_data_t> &input, hls::stream<fir_data_t> &output){
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=Multirate_v4
# 14 "FIR_HLS.cpp"
...
# 29 "FIR_HLS.cpp"
 if (mod_value==0) {
        y1_phase0 = FIR_filter_transposed(H_accu_FIR_dec_40, b_FIR_dec_int_40, 6, input.read());

        y1_ges = y1_phase0 + y1_phase1 + y1_phase2 + y1_phase3;

        y2 = FIR_filter_transposed(H_accu_FIR, b_FIR_kernel, 117, y1_ges);
        output.write(FIR_filter_transposed(H_accu_FIR_int_40, b_FIR_dec_int_40, 6, y2)*4);
        mod_value=1;
    }
    else if (mod_value==1) {
        y1_phase1 = FIR_filter_transposed(H_accu_FIR_dec_43, b_FIR_dec_int_43, 5, input.read());
        output.write(FIR_filter_transposed(H_accu_FIR_int_41, b_FIR_dec_int_41, 5, y2)*4);
        mod_value=2;
    }
    else if (mod_value==2) {
        y1_phase2 = FIR_filter_transposed(H_accu_FIR_dec_42, b_FIR_dec_int_42, 5, input.read());
        output.write(FIR_filter_transposed(H_accu_FIR_int_42, b_FIR_dec_int_42, 5, y2)*4);
        mod_value=3;

    }
    else {
        y1_phase3 = FIR_filter_transposed(H_accu_FIR_dec_41, b_FIR_dec_int_41, 5, input.read());
        output.write( FIR_filter_transposed(H_accu_FIR_int_43, b_FIR_dec_int_43, 5, y2)*4);
        mod_value=0;
    }
...
#pragma HLS PIPELINE
 ...
 VITIS_LOOP_86_1: for(int i=1; i < N_delays; i++)
