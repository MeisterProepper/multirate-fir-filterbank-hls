...
set C_modelArgList {
	...
	{ FIR_delays_read_8 int 16 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "FIR_delays_read", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	{ "Name" : "FIR_delays_read_8", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ FIR_delays_read_8 sc_in sc_lv 16 signal 1 } 
	{ FIR_delays_read_9 sc_in sc_lv 16 signal 2 } 
	{ FIR_delays_write sc_in sc_lv 16 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "FIR_delays_read_8", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "FIR_delays_read_8", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.am_addmul_16s_16s_15ns_32_4_1_U100", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ama_addmuladd_16s_16s_13s_32s_32_4_1_U101", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	FIR_delays_read_8 { ap_none {  { FIR_delays_read_8 in_data 0 16 } } }
