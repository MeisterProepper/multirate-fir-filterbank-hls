...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler FIR_Halfband_v1_ama_addmuladd_16s_16s_13s_32s_32_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "cg_default_interface_gen_dc { \
    id 104 \
    name FIR_delays_read_8 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_FIR_delays_read_8 \
    op interface \
    ports { FIR_delays_read_8 { I 16 vector } } \
} "
}
