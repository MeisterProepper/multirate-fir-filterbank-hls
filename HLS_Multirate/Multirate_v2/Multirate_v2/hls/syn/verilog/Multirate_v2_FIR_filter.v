...
module Multirate_v2_FIR_filter (
        ap_clk,
        ap_rst,
        FIR_delays_read,
        FIR_delays_read_22,
...
Multirate_v2_mul_16s_13s_28_1_0 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 13 ),
...
Multirate_v2_mac_muladd_16s_10s_28s_28_4_0 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 10 ),
...
Multirate_v2_mac_muladd_16s_14ns_28s_30_4_0 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 14 ),
...
endmodule //Multirate_v2_FIR_filter
