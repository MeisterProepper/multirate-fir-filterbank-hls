...
__attribute__((sdx_kernel("Multirate_v2", 0))) void Multirate_v2(hls::stream<fir_data_t> &input, hls::stream<fir_data_t> &output);
...
__attribute__((sdx_kernel("Multirate_v2", 0))) void Multirate_v2(hls::stream<fir_data_t> &input, hls::stream<fir_data_t> &output){
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=Multirate_v2
# 14 "FIR_HLS.cpp"
