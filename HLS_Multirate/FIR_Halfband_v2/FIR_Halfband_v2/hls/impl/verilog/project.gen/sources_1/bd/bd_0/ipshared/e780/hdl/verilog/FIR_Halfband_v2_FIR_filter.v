...
module FIR_Halfband_v2_FIR_filter (
        ap_clk,
        ap_rst,
        FIR_delays_read,
        FIR_delays_read_21,
...
FIR_Halfband_v2_am_addmul_16s_16s_15ns_32_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    .din2_WIDTH( 15 ),
    .dout_WIDTH( 32 ))
am_addmul_16s_16s_15ns_32_4_1_U68(
    .clk(ap_clk),
    .reset(ap_rst),
...
FIR_Halfband_v2_ama_addmuladd_16s_16s_10ns_32s_32_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    ...
    .din3_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
ama_addmuladd_16s_16s_10ns_32s_32_4_1_U69(
    .clk(ap_clk),
    .reset(ap_rst),
...
FIR_Halfband_v2_ama_addmuladd_16s_16s_14s_32s_32_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    ...
    .din3_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
ama_addmuladd_16s_16s_14s_32s_32_4_1_U70(
    .clk(ap_clk),
    .reset(ap_rst),
...
endmodule //FIR_Halfband_v2_FIR_filter
