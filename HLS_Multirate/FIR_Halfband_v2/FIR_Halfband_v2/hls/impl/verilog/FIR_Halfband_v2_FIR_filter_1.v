...
module FIR_Halfband_v2_FIR_filter_1 (
        ap_clk,
        ap_rst,
        FIR_delays_read,
        FIR_delays_read_8,
...
FIR_Halfband_v2_am_addmul_16s_16s_15ns_32_4_1 #(
    ...
    .din2_WIDTH( 15 ),
    .dout_WIDTH( 32 ))
am_addmul_16s_16s_15ns_32_4_1_U80(
    .clk(ap_clk),
    .reset(ap_rst),
...
FIR_Halfband_v2_ama_addmuladd_16s_16s_13s_32s_32_4_1 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    ...
    .din3_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
ama_addmuladd_16s_16s_13s_32s_32_4_1_U81(
    .clk(ap_clk),
    .reset(ap_rst),
...
endmodule //FIR_Halfband_v2_FIR_filter_1
