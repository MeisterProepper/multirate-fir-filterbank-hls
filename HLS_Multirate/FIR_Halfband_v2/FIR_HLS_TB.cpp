...
// File names
const char INPUT_FILENAME[]     = "../../../../../../Matlab/TS_HLS_halfband.dat";
const char REFERENCE_FILENAME[] = "../../../../../../Matlab/TS_HLS_halfband.res";
...
int main() {
    ...
    for (int i = 0; i < num_input_samples; i++) {
        FIR_Halfband_v2(input_stream, output_stream);
    }
