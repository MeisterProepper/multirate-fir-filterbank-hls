...
using hls::sim::Byte;
extern "C" void FIR_Cascade_v2(short*, short*);
extern "C" void apatb_FIR_Cascade_v2_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
auto* soutput_r = createStream((hls::stream<short>*)__xlx_apatb_param_output_r);
  // DUT call
  FIR_Cascade_v2(sinput_r->data<short>(), soutput_r->data<short>());
