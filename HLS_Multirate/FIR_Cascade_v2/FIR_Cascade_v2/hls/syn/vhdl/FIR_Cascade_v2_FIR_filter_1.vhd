...
entity FIR_Cascade_v2_FIR_filter_1 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of FIR_Cascade_v2_FIR_filter_1 is 
...
attribute shreg_extract : string;
    ...
    signal tmp_10_fu_92_p3 : STD_LOGIC_VECTOR (24 downto 0);
    signal tmp_11_fu_104_p3 : STD_LOGIC_VECTOR (18 downto 0);
    ...
    component FIR_Cascade_v2_mac_muladd_16s_16ns_26s_32_4_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
    ...
    component FIR_Cascade_v2_ama_addmuladd_16s_16s_10s_32s_32_4_0 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    mac_muladd_16s_16ns_26s_32_4_0_U90 : component FIR_Cascade_v2_mac_muladd_16s_16ns_26s_32_4_0
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    ama_addmuladd_16s_16s_10s_32s_32_4_0_U91 : component FIR_Cascade_v2_ama_addmuladd_16s_16s_10s_32s_32_4_0
    generic map (
        ID => 1,
        NUM_STAGE => 4,
        din0_WIDTH => 16,
    ...
    grp_fu_169_p2 <= ap_const_lv27_7FFFEB0(10 - 1 downto 0);
        p_shl14_fu_112_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_11_fu_104_p3),26));

        p_shl_fu_100_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(tmp_10_fu_92_p3),26));
    ...
    tmp_10_fu_92_p3 <= (tmp2_fu_86_p2 & ap_const_lv8_0);
    tmp_11_fu_104_p3 <= (tmp2_fu_86_p2 & ap_const_lv2_0);
end behav;
