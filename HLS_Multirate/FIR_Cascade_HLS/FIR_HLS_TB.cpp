...
// File names
const char INPUT_FILENAME[]     = "../../../../../../Matlab/TS_HLS_multirate_cascade.dat";
const char REFERENCE_FILENAME[] = "../../../../../../Matlab/TS_HLS_multirate_cascade.res";
...
int main() {
    ...
    for (int i = 0; i < num_input_samples; i++) {
        FIR_Cascade_HLS(input_stream, output_stream);
    }
