...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler FIR_Cascade_HLS_mac_muladd_16s_16ns_26s_32_4_0 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler FIR_Cascade_HLS_ama_addmuladd_16s_16s_10s_32s_32_4_0 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
