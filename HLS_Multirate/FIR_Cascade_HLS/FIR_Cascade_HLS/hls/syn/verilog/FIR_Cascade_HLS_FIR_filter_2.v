...
module FIR_Cascade_HLS_FIR_filter_2 (
        ap_clk,
        ap_rst,
        FIR_delays_read,
        FIR_delays_read_22,
...
FIR_Cascade_HLS_mac_muladd_16s_16ns_26s_32_4_0 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    .din2_WIDTH( 26 ),
    .dout_WIDTH( 32 ))
mac_muladd_16s_16ns_26s_32_4_0_U111(
    .clk(ap_clk),
    .reset(ap_rst),
...
FIR_Cascade_HLS_ama_addmuladd_16s_16s_10s_32s_32_4_0 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 16 ),
    ...
    .din3_WIDTH( 32 ),
    .dout_WIDTH( 32 ))
ama_addmuladd_16s_16s_10s_32s_32_4_0_U112(
    .clk(ap_clk),
    .reset(ap_rst),
...
assign p_shl14_fu_112_p1 = $signed(tmp_2_fu_104_p3);

assign p_shl_fu_100_p1 = $signed(tmp_1_fu_92_p3);
...
assign tmp_1_fu_92_p3 = {{tmp2_fu_86_p2}, {8'd0}};

assign tmp_2_fu_104_p3 = {{tmp2_fu_86_p2}, {2'd0}};

endmodule //FIR_Cascade_HLS_FIR_filter_2
