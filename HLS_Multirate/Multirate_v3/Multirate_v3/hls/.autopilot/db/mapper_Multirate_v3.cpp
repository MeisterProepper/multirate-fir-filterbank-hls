...
using hls::sim::Byte;
extern "C" void Multirate_v3(short*, short*);
extern "C" void apatb_Multirate_v3_hw(volatile void * __xlx_apatb_param_input_r, volatile void * __xlx_apatb_param_output_r) {
...
auto* soutput_r = createStream((hls::stream<short>*)__xlx_apatb_param_output_r);
  // DUT call
  Multirate_v3(sinput_r->data<short>(), soutput_r->data<short>());
