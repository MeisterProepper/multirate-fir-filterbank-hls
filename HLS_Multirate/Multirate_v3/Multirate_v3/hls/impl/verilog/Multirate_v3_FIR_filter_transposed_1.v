...
module Multirate_v3_FIR_filter_transposed_1 (
        ap_clk,
        ap_rst,
        FIR_delays_read,
        FIR_delays_read_14,
...
Multirate_v3_mul_16s_15ns_31_1_0 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 15 ),
...
Multirate_v3_mul_16s_10ns_26_1_0 #(
    .ID( 1 ),
    .NUM_STAGE( 1 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 10 ),
...
Multirate_v3_mac_muladd_16s_9ns_32s_32_4_0 #(
    .ID( 1 ),
    .NUM_STAGE( 4 ),
    .din0_WIDTH( 16 ),
    .din1_WIDTH( 9 ),
...
endmodule //Multirate_v3_FIR_filter_transposed_1
